...
### HeartStoneアリーナシミュレーター(SPAサイト)
#### Github [hsdraft](https://github.com/yukirin/hsdraft)
#### 担当箇所:全工程(設計、実装、テスト)
#### 使用技術: Python(Tornado)、Git、HTML5、CSS3、Javascript、jQuery、Gulp、heroku、MongoDB、WerckerCI、Knockout.js、Materialize、Jade、sass
<br/>
